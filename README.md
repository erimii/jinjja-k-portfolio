# JinJJa-K / K+DUCK 개발 포트폴리오

K-드라마 장면을 보며 숨은 문화 맥락, 표현, 장면 정보를 이해할 수 있도록 만든 JinJJa-K 프로젝트 포트폴리오입니다.
MVP2 kduck 실험판에서 kduck-home 웹 서비스, 그리고 kduck_react Android shell까지 이어진 제품화 흐름을 함께 정리했습니다.
웹 서비스, 관리자 콘솔, 학습형 MVP2, Android WebView shell 사례를 각각 확인할 수 있습니다.

## 바로 보기

- JinJJa-K 통합 포트폴리오: https://erimii.github.io/jinjja-k-portfolio/
- JinJJa-K 통합 PDF: [JinJJa-K-Portfolio.pdf](./JinJJa-K-Portfolio.pdf)
...
- kduck_react Android shell, native Google Sign-In, Firebase Messaging, 권한 팝업/릴리즈 QA
